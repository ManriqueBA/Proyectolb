...
public class Departamentos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Intelec - Departamentos");

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel2.setText("Añadir/modificar Departamento");

        jLabel3.setText("*Nota: el campo \"id\" se utiliza solo en caso de modificar algún departamento");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id departamento", "Nombre departamento", "Descripción"
            }
        ) {
    ...
    private void bInsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bInsertarActionPerformed
        ...
        String sql;
        sql = "INSERT INTO DEPARTAMENTO (IDDEPARTAMENTO, NOMDEPARTAMENTO, DESCRIPCION) VALUES(" + id + ", '" + nombre + "', '" + descripcion + "'";
        try {
    ...
    private void bModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bModificarActionPerformed
        ...
        String sql;
        sql = "UPDATE DEPARTAMENTO SET NOMDEPARTAMENTO= '" + nombre + "', DESCRIPCION = '" + descripcion + "' WHERE IDDEPARTAMENTO = " + id;
        try {
            comando.executeUpdate(sql);
            actualizarTabla();
        ...
        try {
            ...
            for (int i = 0; respuesta.next(); i++) {
                contenido.insertRow(i,
                        new Object[]{respuesta.getInt("IDDEPARTAMENTO"),
                            respuesta.getString("NOMDEPARTAMENTO"),
